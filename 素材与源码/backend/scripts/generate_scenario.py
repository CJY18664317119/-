...
def generate_scenario(context_embedding, model, tokenizer, device):
    try:
        # 准备输入
        input_text = f"根据以下上下文生成项目情境：\n"
...
if __name__ == '__main__':
    ...
    result = generate_scenario(context_embedding, model, tokenizer, device)
